...
public class AccountForm {
    ...
    protected Savings getSavingsAccountInformation(){
        ...
        try {
    		...
    		System.out.println("Invalid birth date Input ");
    	}
    ...
    protected void transfer() throws AccountNotActiveException, InsufficientBalanceException{
    	...
    	if(isPinValid) {
    		boolean isTransfered=accountManager.transfer(transferInfo, fromAccount, toAccount);
    		transferStatus(isTransfered,transferInfo);
    ...
    public void transferStatus(boolean isTransfered,TransferInfo transferInfo) {
    	if(isTransfered) {
    		
    		System.out.print("Your're account with number "+transferInfo.getFromAccountNumber());
    		System.out.println(" is transferred an amount of "+transferInfo.getTransferAmount()+" to account "+transferInfo.getToAccountNumber());
